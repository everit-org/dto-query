...
public class QDatabasechangelog extends com.querydsl.sql.RelationalPathBase<QDatabasechangelog> {
    ...
    private static final long serialVersionUID = 648708847;
    ...
    public void addMetadata() {
        ...
        addMetadata(dateexecuted, ColumnMetadata.named("DATEEXECUTED").withIndex(4).ofType(Types.TIMESTAMP).withSize(26).withDigits(6).notNull());
